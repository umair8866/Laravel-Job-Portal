        ...
        <div class="card border-0 shadow p-5">
            ...
            <div class="row">
                <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                    <input type="text" class="form-control" name="keywords" id="keyword" placeholder="Keywords">
                </div>
                <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
            ...
            @foreach ($categories as $category)
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="single_catagory">
                        ...
                        <p class="mb-0"> <span>{{ count($category->jobs) }}</span> Available position</p>
                    </div>
                </div>
            @endforeach
            @endif
            ...
            @foreach ($jobtypes as $jobtype)
                <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="single_catagory">
                        ...
                        <p class="mb-0"> <span>{{ count($jobtype->jobs) }}</span> Available position</p>
                    </div>
                </div>
            @endforeach
            @endif
